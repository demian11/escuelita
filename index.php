            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <!-- Aqui estaran algunos inconos para la pagina para dar mas diseño -->

                        <!-- Card 
                        <div class="card">
                            <div class="card-icon">
                                <span class="fa-brand fa-html5"></span>
                            </div>
                            <div class="card-body">
                                <h4 class="card-title">HTML</h4>
                                <div class="card-text">Puedes crear la estructura y el contenido de una página web, incluyendo títulos, párrafos, listas, imágenes y enlaces. Es el lenguaje fundamental para dar forma a la información en la web.</div>
                            </div>
                        </div>
                        -->
                        <!-- end of card -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-text">Te permite dar estilo y diseño a tus páginas web. Puedes cambiar colores, fuentes, tamaños, márgenes y agregar efectos visuales para hacer que tu sitio sea atractivo y coherente en términos de apariencia.</div>
                            </div>
                        </div>
                        -->
                        <!-- end of card -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-text">Es un lenguaje de programación que te permite agregar interactividad y funcionalidad a tu página web.</div>
                            </div>
                        </div>
                        -->
                        <!-- end of card -->
