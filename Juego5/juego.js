...
let orden_correcto = ['while', 'condicion', 'expresion','expresion final'];

//Palabras desordenadas para mostrar en opciones
let palabras_juego = ['lista', 'while', 'condicion', 'expresion final', 'expresion', 'variable'];
...
comprobar.onclick = function(){
    ...
    if(posLibre==-1){
        ...
        if(totalAciertos==orden_correcto.length){
            ...
            txtResultado.innerHTML = "No hay problema, intentalo de nuevo";
        }
    }else{
